...
public class PathEffectView extends View {
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        mEffects[2] = new DiscretePathEffect(13.0f, 5.0f);
        ...
        Path p = new Path();
        p.addRect(0, 0, 18, 18, Path.Direction.CCW);
        // shape则是指填充图形，advance指每个图形间的间距，phase为绘制时的偏移量，style为该类自由的枚举值
        mEffects[4] = new PathDashPathEffect(p, 22, mPhase, PathDashPathEffect.Style.ROTATE);
        // 组合效果
